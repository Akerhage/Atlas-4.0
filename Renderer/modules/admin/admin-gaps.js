...
<span style="font-size:10px; opacity:0.5; display:flex; align-items:center; gap:5px;">
<span style="color:#4cd964; background:rgba(76,217,100,0.12); border:1px solid rgba(76,217,100,0.3); border-radius:4px; padding:1px 6px;">TS ✓</span>
Transportstyrelsen-fallback hittade svar
</span>
<span style="font-size:10px; opacity:0.5; display:flex; align-items:center; gap:5px;">
<span style="color:#ff9f0a; background:rgba(255,159,10,0.12); border:1px solid rgba(255,159,10,0.3); border-radius:4px; padding:1px 6px;">TS ✗</span>
Transportstyrelsen testades men gav inget svar
</span>
<span style="font-size:10px; opacity:0.5; display:flex; align-items:center; gap:5px;">
<span style="color:#636366; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08); border-radius:4px; padding:1px 6px;">RAG</span>
Enbart RAG — Transportstyrelsen testades ej
</span>
<span style="font-size:10px; opacity:0.5; display:flex; align-items:center; gap:5px;">
<span style="color:#0071e3; background:rgba(0,113,227,0.12); border:1px solid rgba(0,113,227,0.3); border-radius:4px; padding:1px 6px;">2×</span>
Samma fråga har ställts flera gånger
</span>
</div>
</div>
