...
const onlineUrl = config.SERVER_URL ? config.SERVER_URL.replace(/\/$/, '') + '/index.html' : null;
const localPath = `file://${getRendererPath('index.html')}`;
const startUrl = onlineUrl || localPath;

console.log("🚀 Startar Atlas UI från:", startUrl);
...
mainWindow.loadURL(onlineUrl || localPath);
...
console.log('[Main-Client] Credentials mottagna från loader.');
